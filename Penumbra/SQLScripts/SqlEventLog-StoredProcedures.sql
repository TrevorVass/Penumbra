...
GRANT EXECUTE ON dbo.AddCategory TO [domain\penumbra];
GRANT EXECUTE ON dbo.AddEvent TO [domain\penumbra];
GRANT EXECUTE ON dbo.AddSeverityLevel TO [domain\penumbra];
GRANT EXECUTE ON dbo.AddSource TO [domain\penumbra];
GRANT EXECUTE ON dbo.DeleteCategory TO [domain\penumbra];
GRANT EXECUTE ON dbo.DeleteEvent TO [domain\penumbra];
GRANT EXECUTE ON dbo.DeleteSeverityLevel TO [domain\penumbra];
GRANT EXECUTE ON dbo.DeleteSource TO [domain\penumbra];
GRANT EXECUTE ON dbo.GetCategories TO [domain\penumbra];
GRANT EXECUTE ON dbo.GetCategoryIdByName TO [domain\penumbra];
GRANT EXECUTE ON dbo.GetEvents TO [domain\penumbra];
GRANT EXECUTE ON dbo.GetSeverityLevels TO [domain\penumbra];
GRANT EXECUTE ON dbo.GetSources TO [domain\penumbra];
GRANT EXECUTE ON dbo.UpdateCategory TO [domain\penumbra];
GRANT EXECUTE ON dbo.UpdateEvent TO [domain\penumbra];
GRANT EXECUTE ON dbo.UpdateSeverityLevel TO [domain\penumbra];
GRANT EXECUTE ON dbo.UpdateSource TO [domain\penumbra];
GO